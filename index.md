...
humandate: "June 6, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Sameh Othman"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
<p><a href="{{https://events.hifis.net/event/1308/}}">Post-workshop Survey</a></p>
...
{% else %}
<p><a href="{{ https://events.hifis.net/event/1308/ }}{{ site.github.project_title }}">Post-workshop Survey</a></p>
{% endif %}
